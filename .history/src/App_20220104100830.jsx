    ...
    <div>
      ...
      <Container className="w-75 m-auto position-relative p-0 mb-5 d-flex flex-lg-row flex-column">
        <div className="column d-flex flex-column">
          <div className="overflow-hidden mx-5"><img className="image-square" src={Img6} alt="" /></div>
          <div className="overflow-hidden  mx-5"><img className="image-square" src={Img7} alt="" /></div>
        </div>
        <div className="column d-flex flex-column">
