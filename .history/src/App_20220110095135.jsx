...
function App() {
  ...
  const carMove = () => {
    if (document.getElementsByClassName("container3")[0].getBoundingClientRect().top < 300) {
  ...
  console.log(document.getElementsByClassName("container3")[0].getBoundingClientRect().top)
}
