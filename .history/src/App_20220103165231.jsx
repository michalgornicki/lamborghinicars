...
<Container className="mw-100 position-relative p-0 mb-5 d-flex flex-row">
<div className="image-text">
<h3 className="display-1">Models</h3>
</div>
<div className="column w-25 d-flex flex-column">
<img className ="image-square" src={Dealer} alt="" />
<img className ="image-square" src={Dealer} alt="" />

</div>
<div className="column d-flex flex-column">
<img className ="image-square-large" src={Dealer} alt="" />
...
<Navbar className="py-5" collapseOnSelect expand="lg" bg="black" variant="dark">
  <Container className="mw-90 m-auto">
  <Navbar.Toggle aria-controls="responsive-navbar-nav" />
  <Navbar.Collapse id="responsive-navbar-nav w-100">
