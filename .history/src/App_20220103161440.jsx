...
function App() {
  ...
  <Navbar.Brand href="#home" className="w-50 text-center m-auto"><img className="image" src={Logo} alt=""/></Navbar.Brand>
    <Nav className="w-35 justify-content-between">
    <NavDropdown title="Solutions" id="collasible-nav-dropdown">
        <NavDropdown.Item href="#action/3.1">Customization</NavDropdown.Item>
        <NavDropdown.Item href="#action/3.2"><Accesories></Accesories></NavDropdown.Item>
