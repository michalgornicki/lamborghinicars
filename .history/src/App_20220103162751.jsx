...
<Container className="mw-100 position-relative">
<img className ="image" src={Dealer} alt="" />

<h3 className="display-4 image-text">Find dealer in your city</h3>
<h3 className="display-1 image-text">Find dealer in your city</h3>
</Container>
