      ...
      <Container className="h-100vh mobile-hide">
        ...
        <div className="d-flex flex-column mx-auto w-50 m-top-30">
          ...
          <div className="flex-row border-bottom mb-3">
            ...
            <span className="d-inline-block w-50"> <span id="displacement">6498</span> cm3 (396.5 cu in)</span>
          </div>
          <div className="flex-row border-bottom mb-3">
          ...
          <div className="flex-row border-bottom mb-3">
            ...
            <span className="d-inline-block w-50"><span id="speed">0</span> km/h</span>
          </div>
          <div className="flex-row border-bottom mb-3">
