  ...
  return (
    <div>
      ...
      <Container className="h-100vh mobile-hide">
        ...
        <div className="d-flex flex-column mx-auto w-75 m-top-30">
        <div className="flex-row">
            <span className="d-inline-block w-100 text-center mb-4 display-5">Technical specification</span>
          </div>
          <div className="flex-row">
            <span className="d-inline-block w-50 text-center">Displacement</span>
            <span className="d-inline-block w-50 text-center">6,498 cm3 (396.5 cu in)</span>
          </div>
          <div className="flex-row">
          <span className="d-inline-block w-50 text-center">MAX. POWER</span>
            <span className="d-inline-block w-50 text-center">780 CV (574 kW) at 8,500 rpm</span>
          </div>
          <div className="flex-row">
          <span className="d-inline-block w-50 text-center">TOP SPEED</span>
            <span className="d-inline-block w-50 text-center">355 km/h</span>
          </div>
          <div className="flex-row">
          <span className="d-inline-block w-50 text-center">ACCELERATION 0-100 KM/H (MPH 0-62)</span>
            <span className="d-inline-block w-50 text-center">2.8 s</span>
          </div>
          <div className="flex-row">
          <span className="d-inline-block w-50 text-center">TRANSMISSION TYPE</span>
            <span className="d-inline-block w-50 text-center">Electronically controlled all-wheel drive system (Haldex gen. IV) with rear mechanical self-locking differential</span>
          </div>
        </div>
      </Container>
