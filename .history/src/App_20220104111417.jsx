      ...
      <Container className="h-100vh mobile-hide">
        ...
        <div className="flex-row">
          ...
          <span className="d-inline-block w-50 text-center">TRANSMISSION TYPE</span>
            <span className="d-inline-block w-50 text-right">Electronically controlled all-wheel drive system (Haldex gen. IV) with rear mechanical self-locking differential</span>
          </div>
        </div>
      </Container>
